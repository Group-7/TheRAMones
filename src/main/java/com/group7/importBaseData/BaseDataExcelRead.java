...
public class BaseDataExcelRead {
	...
	public BaseDataExcelRead(){
		stringInput = "/home/niall/sample_dataset.xls";
	}
	...
	public Collection<BaseData> readExcelFile() throws BiffException, IOException{
		...
		try {
			...
			for (int j = 1; j <  sheet.getRows() ; j++) {
				...
				int ueTypeTac = Integer.parseInt(validation.ueTypeTacValidation(strings[2]));
				int mcc = Integer.parseInt(validation.isMCCValid(strings[3]));
	...
	public void writeToLogError(int errorLineNo) {
		final String FILE_PATH = "/home/niall/errorlog.txt";
